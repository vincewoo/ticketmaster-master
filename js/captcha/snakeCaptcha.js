...
// Canvas is 15x10 (300/20 x 200/20), so x: 0-14, y: 0-9
const snakeLayouts = [
    {
        direction: 'right',
        layout: [
            // Long winding snake - 40 segments - Head at (1,3) going RIGHT, clear runway y=3
            { x: 1, y: 3 }, { x: 0, y: 3 }, { x: 0, y: 2 }, { x: 0, y: 1 },
            { x: 0, y: 0 }, { x: 1, y: 0 }, { x: 2, y: 0 }, { x: 3, y: 0 },
            { x: 4, y: 0 }, { x: 5, y: 0 }, { x: 6, y: 0 }, { x: 7, y: 0 },
            { x: 8, y: 0 }, { x: 9, y: 0 }, { x: 10, y: 0 }, { x: 11, y: 0 },
            { x: 12, y: 0 }, { x: 13, y: 0 }, { x: 14, y: 0 }, { x: 14, y: 1 },
            ...
            { x: 5, y: 9 }, { x: 4, y: 9 }, { x: 3, y: 9 }, { x: 2, y: 9 }
        ]
    },
    {
        direction: 'down',
        layout: [
            // Perimeter pattern - 42 segments - Head at (2,1) going DOWN, clear runway x=2
            { x: 2, y: 1 }, { x: 2, y: 0 }, { x: 3, y: 0 }, { x: 4, y: 0 },
            { x: 5, y: 0 }, { x: 6, y: 0 }, { x: 7, y: 0 }, { x: 8, y: 0 },
            { x: 9, y: 0 }, { x: 10, y: 0 }, { x: 11, y: 0 }, { x: 12, y: 0 },
            { x: 13, y: 0 }, { x: 14, y: 0 }, { x: 14, y: 1 }, { x: 14, y: 2 },
            { x: 14, y: 3 }, { x: 14, y: 4 }, { x: 14, y: 5 }, { x: 14, y: 6 },
            { x: 14, y: 7 }, { x: 14, y: 8 }, { x: 14, y: 9 }, { x: 13, y: 9 },
            { x: 12, y: 9 }, { x: 11, y: 9 }, { x: 10, y: 9 }, { x: 9, y: 9 },
    ...
    },
    {
        direction: 'left',
        layout: [
            // Spiral pattern - 38 segments - Head at (13,6) going LEFT, clear runway y=6
            { x: 13, y: 6 }, { x: 14, y: 6 }, { x: 14, y: 7 }, { x: 14, y: 8 },
            { x: 14, y: 9 }, { x: 13, y: 9 }, { x: 12, y: 9 }, { x: 11, y: 9 },
            { x: 10, y: 9 }, { x: 9, y: 9 }, { x: 8, y: 9 }, { x: 7, y: 9 },
            { x: 6, y: 9 }, { x: 5, y: 9 }, { x: 4, y: 9 }, { x: 3, y: 9 },
            { x: 2, y: 9 }, { x: 1, y: 9 }, { x: 0, y: 9 }, { x: 0, y: 8 },
